...
df = generate_Data_third(1000, 5, 1,500, myFiles)
...
for epoch in range(EPOCHS):  # loop over the dataset multiple times
    ...
    for i, data in enumerate(data_train_third, 0):
        ...
        loss = criterion(outputs, labels, 10e-3, 0.001, net3, inputs)
        loss.backward()
        optm3.step()
        gc.collect()
        ...
        if i % 20000 == 19999:    # print every 2000 mini-batches
            ...
            running_loss = 0.0
    #if epoch % 10 == 0:
    #  torch.save(net3, 'our_third_5_1')

print('Finished Training')
torch.save(net3, 'our_third_5_1.pt')
